...
class Config(object):
  ...
  BOT_TOKEN = os.environ.get("BOT_TOKEN", "8323347381:AAFG_b6O7RPhCPOXB7FKDehyQhu_em74Ijc")
  BOT_USERNAME = os.environ.get("BOT_USERNAME", "AdultFileStorebot")
  DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1003597719446"))
  ...
  DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://Demo270:Demo270@cluster0.ls1igsg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
  ...
  FORWARD_AS_COPY = bool(os.environ.get("FORWARD_AS_COPY", Fasel))
